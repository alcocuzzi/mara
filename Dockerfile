...
ENV PY_TOOLS="configparser==7.2.0 urllib3==2.0.7 pre-commit==4.2.0 rich==13.7.1 boto3==1.38.36 botocore==1.38.36 PyGithub==2.6.1 pygit2==1.18.0 tabulate==0.9.0 poetry==2.2.1 ansible==12.0.0 typer==0.21.1 psycopg2==2.9.12"
